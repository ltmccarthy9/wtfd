...
export default function Home() {
  ...
  return (
    <main id='landing' className='flex flex-col'>
        <div className='h-screen p-6 flex flex-col gap-2 mx-auto mt-20 sm:mt-40 w-full max-w-7xl text-4xl md:text-5xl
         font-bold text-center text-gray-700 dark:text-gray-50'>
          ...
          <div className='flex flex-wrap gap-4 mx-auto mt-20 text-3xl md:text-4xl'>
          <h1 className='text-gray-700 dark:text-gray-50 font-bold mb-2 mx-auto'>Introducing: </h1>
          <h1 className='text-indigo-500 dark:text-indigo-400 font-bold mx-auto mb-4'>What The Fam Doing?</h1>
          </div>
