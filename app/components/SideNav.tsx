...
export default function SideNav() {
    ...
    return (
        <nav className={nav ? "h-screen w-56 bg-white dark:bg-[#343c48] shadow-md dark:shadow-gray-800 fixed top-0 left-0 ease-in duration-200"
                            : "h-screen w-56 bg-white dark:bg-[#343c48] shadow-md dark:shadow-gray-800 fixed top-0 -left-44 ease-in duration-200"}>
            ...
            <div className="flex mt-2 mb-4">
                ...
                <ThemeButton display='flex' dark={dark} setDark={setDark}/>
