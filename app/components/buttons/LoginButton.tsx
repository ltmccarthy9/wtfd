  ...
  return (
    <div className='m-auto'>
      ...
      <div className={loginActive ? 'fixed h-screen w-full top-0 right-0 bg-black/60 p-2' : 'm-auto hidden'}>
        <div className={loginActive ? "bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mx-auto mt-40 max-w-md h-fit flex flex-col" : 'hidden'}>
           ...
           <div className='flex flex-col gap-10 mt-8 w-5/6 m-auto'>
            ...
            <button type='submit' className='bg-indigo-500 rounded-lg p-2 font-semibold hover:bg-indigo-600 ease-in duration-100 mt-2 mb-10'>login</button>
           </div>
        </div>
      </div>
