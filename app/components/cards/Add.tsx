  ...
  return (
    <div className=" text-gray-700 dark:text-gray-50 
        ...
        <div className='fixed top-0 left-0 h-screen w-full bg-black/75 ease-in-out duration-200'>
          <div className='h-96 w-96 bg-white dark:bg-gray-700 mx-auto mt-60 rounded-lg flex flex-col justify-between'>
            <button type='button' onClick={handleExit} className='p-3 text-gray-500 hover:text-gray-700 dark:text-gray-50
             dark:hover:text-gray-300 hover:scale-105 ease-in duration-100 flex ml-auto'>
              <RxCross2 size={28} />
            </button>
            <h1 className='text-gray-700 dark:text-gray-50 text-2xl font-semibold text-center'>Add family</h1>
            <div className='flex mt-auto bg-slate mb-20 mx-auto'>
              <form className='flex gap-2'>
                <input value={family} onChange={(e) => setFamily(e.target.value)} className='mt-auto h-10 bg-gray-100 dark:bg-gray-600 rounded-lg p-2 outline-none' placeholder='Family Name'></input>
